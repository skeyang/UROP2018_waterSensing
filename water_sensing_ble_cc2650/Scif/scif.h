/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/Users/Asus/workspace_v8/adc_ranger_cc2650_launchxl/Scif/adc.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2018-09-11 22:34:13.595
  * - <b>Computer</b>:         PC
  * - <b>User</b>:             Asus
  *
  ...
  * - ADC:
  *     - <b>A: Temperature</b>: DIO23
  *     - <b>A: Pressure</b>: DIO24
  *     - <b>A: Flow rate</b>: DIO25
  *     - <b>A: Conductivity</b>: DIO26
  *     - <b>A: Turbidity</b>: DIO27
  *
  *
...
/// ADC I/O mapping: Temperature
#define SCIF_ADC_DIO_A_TEMP_INPUT 23
/// ADC I/O mapping: Pressure
#define SCIF_ADC_DIO_A_PRESS_INPUT 24
/// ADC I/O mapping: Flow rate
#define SCIF_ADC_DIO_A_FLOW_INPUT 25
/// ADC I/O mapping: Conductivity
#define SCIF_ADC_DIO_A_CONDUCT_INPUT 26
/// ADC I/O mapping: Turbidity
#define SCIF_ADC_DIO_A_TURB_INPUT 27
...
typedef struct {
    uint16_t adcConductivityValue; ///< 
    uint16_t adcFlowValue;         ///< 
    uint16_t adcPressureValue;     ///< 
    uint16_t adcTempValue;         ///< 
    uint16_t adcTurbidityValue;    ///< 
} SCIF_ADC_OUTPUT_T;
